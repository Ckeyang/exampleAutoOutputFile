...
Image.prototype = {
    ...
    _createEditPanel: function _createEditPanel() {
        ...
        var center = getRandom('center');
        var right = getRandom('right');
        var input = getRandom('input');

        // tab 配置
        var tabsConfig = [{
            title: '编辑图片',
            tpl: '<div>\n                    <div class="w-e-button-container" style="border-bottom:1px solid #f1f1f1;padding-bottom:5px;margin-bottom:5px;">\n                        <span style="float:left;font-size:14px;margin:4px 5px 0 5px;color:#333;">\u6700\u5927\u5BBD\u5EA6\uFF1A</span>\n                        <button id="' + width30 + '" class="left">30%</button>\n                        <button id="' + width50 + '" class="left">50%</button>\n                        <button id="' + width100 + '" class="left">100%</button>\n                    </div>\n                    <div class="w-e-button-container" style="border-bottom:1px solid #f1f1f1;padding-bottom:5px;margin-bottom:5px;">\n                        <span style="float:left;font-size:14px;margin:4px 5px 0 5px;color:#333;">\u4F4D\u7F6E\uFF1A</span>\n                        <button id="' + center + '" class="left">\u5C45\u4E2D</button>\n                        <button id="' + right + '" class="left">\u9760\u53F3</button>\n                        <input id="' + input + '" style="width:50px;margin-top:5px;" placeholder="\u95F4\u8DDD" class="left"/>\n                    </div>\n                    <div class="w-e-button-container">\n                        <button id="' + delBtn + '" class="gray left">\u5220\u9664\u56FE\u7247</button>\n                    </dv>\n                </div>',
            events: [{
                selector: '#' + width30,
                type: 'click',
                fn: function fn() {
                ...
                fn: function fn() {
                    ...
                    if ($img) {
                        $img.css('float', 'right');
                        $img.css('margin-right', $('#' + input).val() + 'px');
                    }
                }
            }, {
                selector: '#' + width50,
