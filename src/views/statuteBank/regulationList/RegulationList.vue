  ...
  <div class="content-warp">
    ...
    <div class="regulation-tb box-style_common">
      ...
      highlight-hover-row>
        ...
        <vxe-table-column field="identifyCode" title="发布号" width="250" show-overflow-tooltip>
          <template slot-scope="scope">
        ...
        <vxe-table-column title="替代发布号" width="250" show-overflow-tooltip>
