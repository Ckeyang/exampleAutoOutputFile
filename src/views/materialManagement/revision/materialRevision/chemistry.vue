<template>
  <div class="chemistryInput">
    <!-- <h3  id="CHEMISTRY">化学类</h3>MAC
PC-TWA
PC-STEL
PC-TWA呼尘
PC-TWA总尘
    ...
    <div class="flexWrap">
      <span>PC-TWA呼尘</span>
      <span>{{model.pctwaRespirableDust}}</span>
      <span>
        <revisionRule
          :value="getItem('pctwaRespirableDust')"
          @input="setItem"
          size="mini"
          btnTilte="结果值修约"
          hasRuleBtnTilte="结果值修约"
    ...
    <div class="flexWrap">
      <span>PC-TWA总尘</span>
      <span>{{model.pctwaTotalDust}}</span>
      <span>
        <revisionRule
          :value="getItem('pctwaTotalDust')"
          @input="setItem"
          size="mini"
          btnTilte="结果值修约"
          hasRuleBtnTilte="结果值修约"
