<template>
  <div class="powerFrequencyElectricFieldInput">
    <!-- <h3 id="POWER_FREQUENCY_ELECTRIC_FIELD">工频电场</h3> -->
    <div class="flexWrap">
      <span>电场强度（kV/m）</span>
      <span>{{model.electricFieldIntensity}}</span>
      <span>
        <revisionRule
          :value="getItem('electricFieldIntensity$50HZ')"
          @input="setItem"
          size="mini"
          btnTilte="结果值修约"
...
export default {
  name: "powerFrequencyElectricFieldInput",
  props: {
    model: Object,
    substanceId: String
  },
