<template>
  <div class="middle-box">
    <el-scrollbar :style="{height:(winHeight-76) +'px'}">
      <div class="middle" ref='templateFormBox'>
        <div class="from-box" :class="{'isShowTips':isShowTips}">
    ...
    <backTop scrollbarClass='.middle-box .el-scrollbar__wrap'  />
  </div>
</template>
<script>
...
export default {
  ...
  watch: {
    templateForm(val) {
      this.isShowTips = !val.length; //没有数据时显示提示框
    }
  },
  mounted() {
    this.scrollbarNode = document.querySelector('.middle-box .el-scrollbar__wrap');
  },
  methods: {
