...
function getRandomImgSrc() {
  return '/static/images/' + getRandomNumberByRange(1, 11) + '.jpg';
}
...
class Jigsaw {
  ...
  bindEvents() {
    ...
    this.block.addEventListener('mousedown', this.handleDragStart)
    this.block.addEventListener('touchstart', this.handleDragStart)
  ...
  destroyedEvent() {
    ...
    this.block.removeEventListener('mousedown', this.handleDragStart)
    this.block.removeEventListener('touchstart', this.handleDragStart)
